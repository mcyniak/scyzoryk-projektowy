...
const apps = [
  ...
  { name: 'Przypisywanie plików do folderów', dir: path.join(ROOT, 'apps', 'karty-katalogowe'), deps: ['express', 'multer', 'read-excel-file', 'sanitize-filename', 'express-rate-limit'] },
  ...
  { name: 'Obsługa całej inwestycji', dir: path.join(ROOT, 'apps', 'pipeline'), deps: ['express', 'multer', 'express-rate-limit', 'read-excel-file', 'adm-zip', 'exceljs'] },
  { name: 'Kreator wzorów seryjnych', dir: path.join(ROOT, 'apps', 'kreator-wzorow'), deps: ['express', 'multer', 'express-rate-limit', 'read-excel-file', 'adm-zip', 'sanitize-filename'] }
];
