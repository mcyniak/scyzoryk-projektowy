...
- klucz Google Cloud Vision dla narzędzia OCR audytów.
...
Większość operacji odbywa się wyłącznie lokalnie. **Wyjątkiem jest OCR audytów**, który podczas rozpoznawania tekstu korzysta z Google Cloud Vision i przesyła do tej usługi strony wybrane do analizy. Pozostałe narzędzia nie wysyłają dokumentów do zewnętrznych usług.
