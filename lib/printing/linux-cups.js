...
async function printFile(filePath, printerName, options = {}) {
  ...
  if (path.extname(filePath).toLowerCase() === '.pdf') {
    sanitizedPath = await sanitizePdfForPrinting(filePath);
  ...
  try {
    ...
    // zadania, wiec tymczasowy zsanityzowany plik mozna bezpiecznie usunac
    // zaraz po powrocie polecenia, bez czekania na fizyczny wydruk.
